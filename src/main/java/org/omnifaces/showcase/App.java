...
public class App {
	...
	private static String initPoweredBy() {
		return String.format("%s%nOmniFaces %s%nPrimeFaces %s%n%s",
			...
			"5.2", // PrimeFaces Constants.VERSION is since 4.0 moved to RequestContext#getApplicationContext(), however the access point has changed from application based to request based.
			Faces.getServerInfo());
	}
